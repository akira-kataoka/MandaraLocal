// =====================================================================
// pref_table.js  -- Japan prefecture code <-> name lookup
// Pref code follows ISO 3166-2:JP (1=Hokkaido .. 47=Okinawa)
// =====================================================================

export const PREFECTURES = [
  { code:  1, ja: "北海道",   en: "Hokkaido" },
  { code:  2, ja: "青森県",   en: "Aomori" },
  { code:  3, ja: "岩手県",   en: "Iwate" },
  { code:  4, ja: "宮城県",   en: "Miyagi" },
  { code:  5, ja: "秋田県",   en: "Akita" },
  { code:  6, ja: "山形県",   en: "Yamagata" },
  { code:  7, ja: "福島県",   en: "Fukushima" },
  { code:  8, ja: "茨城県",   en: "Ibaraki" },
  { code:  9, ja: "栃木県",   en: "Tochigi" },
...
export const PREF_CODE_TO_NAME = Object.fromEntries(
  PREFECTURES.map(p => [p.code, p.ja])
);

export const PREF_NAME_TO_CODE = (() => {
  const m = {};
  for (const p of PREFECTURES) {
    m[p.ja] = p.code;
    // also the "no suffix" form
    const noSuffix = p.ja.replace(/(都|道|府|県)$/u, "");
    if (noSuffix && noSuffix !== p.ja) m[noSuffix] = p.code;
    m[p.en] = p.code;
    m[p.en.toLowerCase()] = p.code;
  }
  return m;
})();
